...
void setup() {
  ...
  printer.println("Print the 75x75 pixel logo in adalogo.h");
  printer.printBitmap2(adalogo_width, adalogo_height, adalogo_data);

  // Print the 135x135 pixel QR code in adaqrcode.h:
  printer.println("Print the 135x135 pixel QR code in adaqrcode.h");
  printer.printBitmap2(adaqrcode_width, adaqrcode_height, adaqrcode_data);

  // Print the 384x384 pixel QR code in test_image.h:
  printer.println("Print the 384x384 pixel QR code in test_image.h");
  printer.printBitmap2(test_width, test_height, test_data);
